...
export default () => (
  ...
  <nav className="bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100">
    <div className="container flex items-center justify-center p-6 mx-auto text-gray-500">
